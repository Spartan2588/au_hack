        ...
        <section class="about-section cities-section">
          <div class="container">
            <div class="section-header">
              ...
              <p>Real-time intelligence for India's major urban centers</p>
            </div>
            <div class="cities-grid">
              ...
              <div class="city-card glass">
                <h3>Delhi</h3>
                <p class="city-coords">28.7041°N, 77.1025°E</p>
                <p class="city-desc">The capital region, focusing on extreme environmental pollution and public health.</p>
              </div>
              <div class="city-card glass">
                <h3>Bangalore</h3>
                <p class="city-coords">12.9716°N, 77.5946°E</p>
                <p class="city-desc">Technology hub, monitoring resource constraints and rapid urban growth impacts.</p>
              </div>
            </div>
          </div>
        </section>
